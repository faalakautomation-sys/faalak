...
const TestimonialCard = ({ item, index }) => (
  <motion.article
    ...
    viewport={{ once: true }}
    className="flex h-full flex-col rounded-2xl border border-gray-200 bg-white/90 p-6 shadow-[0_18px_40px_-24px_rgba(30,64,175,0.18)] dark:border-gray-700 dark:bg-gray-900/90"
  >
    ...
    <p className="flex-1 text-sm leading-6 text-gray-600 dark:text-gray-300">&ldquo;{item.quote}&rdquo;</p>
      ...
      <div className="relative w-full max-w-6xl">
        ...
        >
          {testimonialsData.map((item, index) => (
            <div key={item.name} className="w-[80%] shrink-0 snap-center sm:w-auto sm:shrink">
